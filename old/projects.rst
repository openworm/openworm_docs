...
.. toctree::
   ...
   Projects/muscle-neuron-integration
...
The goal of this project is to underpin our muscle and neuron models with
biological data. This will be accomplished by creating biologically-realistic
ion channel models from experimental data, which will then give rise to neural
dynamics.

More detailed information is available on the :ref:`Muscle-Neuron integration project page <muscle-neuron-integration>`.

.. |Project overview| image:: https://docs.google.com/drawings/d/12QMz1LNvKfS1iiYOPCSCkXTU7JQHKJQkjLwN3WLSXYc/pub?w=755&h=493
