...
More information about working with the data within it and other data entities can be found on the data representation project page \<data-rep-neuroml\>.
...
More information about working with the data within it and other data entities can be found on the data representation project page \<data-rep-muscle\>.
...
If you'd be interested to help with tuning the model, please check out the Optimization project page \<optimization\>.
