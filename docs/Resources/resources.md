...
Our website [contains an additional list of resources](https://www.openworm.org/science.html) that are useful to biologists in particular.
...
![image](https://www.geppetto.org/images/cn2.png)

More information on running Geppetto is [available online](https://geppetto.org).
...
![image](https://i.imgur.com/KSWjCaW.jpg)
...
![image](https://i.imgur.com/OG7sOAD.jpg)
...
Explore the c. elegans in 3D! The [WormBrowser](https://browser.openworm.org) is an interactive virtual experience of browsing the C. elegans worm anatomy. This is built from the [Virtual Worm Blender files](https://caltech.wormbase.org/virtualworm/)
