...
- **tierpsy-tracker:** If the OpenWorm fork reads WCON, it may replace the entire 33-hour analysis toolbox revival ([DD017](../design_documents/DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md))
- **CE_locomotion:** Already implements `StretchReceptor.cpp` — 30-50 hours of proprioception work saved ([DD019](../design_documents/DD019_Proprioceptive_Feedback_and_Motor_Coordination.md))
...
| [DD012](../design_documents/DD012_Dynamic_Visualization_Architecture.md) (Visualization) | Worm3DViewer, OpenWorm (Docker) | wormbrowser, WCONViewer, Worm2D, NemaNode (interactive reference) |
| [DD012.2](../design_documents/DD012.2_Anatomical_Mesh_Deformation_Pipeline.md) (Mesh Deformation) | Blender2NeuroML (Virtual Worm meshes) | — |
| [DD013](../design_documents/DD013_Hybrid_Mechanistic_ML_Framework.md) (Hybrid ML) | openworm-ml (TBD) | CE_locomotion, wormvae (VAE), wormpose (pose data), CelegansNeuromechanicalGaitModulation (training data), multi-dev-sibernetic (bulk sims) |
| [DD014](../design_documents/DD014_Egg_Laying_System_Architecture.md) (Egg-Laying) | c302 | — |
| [DD015](../design_documents/DD015_Closed_Loop_Touch_Response.md) (Touch) | c302, sibernetic (bidirectional coupling) | — |
| [DD016](../design_documents/DD016_Connectome_Data_Access_and_Dataset_Policy.md) (Connectome) | ConnectomeToolbox | wormneuroatlas (complementary), NemaNode (cross-validation), VarshneyEtAl2011 (historical) |
| [DD017](../design_documents/DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md) (Movement Toolbox) | open-worm-analysis-toolbox, tracker-commons | tierpsy-tracker (may replace toolbox), wormpose (skeleton bridge) |
| [DD019](../design_documents/DD019_Proprioceptive_Feedback_and_Motor_Coordination.md) (Proprioception) | c302, sibernetic | CE_locomotion (StretchReceptor.cpp), CelegansNeuromechanicalGaitModulation (gait logic), NicolettiEtAl2024_MN_IN (B-class templates) |
| [DD020](../design_documents/DD020_Validation_Data_Acquisition_Pipeline.md) (Validation Data) | — | NeuroPAL, wormneuroatlas (validation datasets) |
...
| [owmeta-movement](https://github.com/openworm/owmeta-movement) | 2021-12-24 | 2 | Movement data utilities ([DD017](../design_documents/DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md) related) |
...
| [VarshneyEtAl2011](https://github.com/openworm/VarshneyEtAl2011) | 2024-02-09 | 0 | Historical connectome data ([DD016](../design_documents/DD016_Connectome_Data_Access_and_Dataset_Policy.md) uses Cook2019 instead) |
...
| [movement_cloud](https://github.com/openworm/movement_cloud) | 2022-11-15 | 6 | Cloud movement analysis — superseded by [DD017](../design_documents/DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md) revival plan |
...
| [tests](https://github.com/openworm/tests) | 2018-06-03 | 3 | Cross-repo tests | [DD011](../design_documents/DD011_Simulation_Stack_Architecture.md) (historical CI patterns) |
...
| [bionet](https://github.com/openworm/bionet) | 2015-04-26 | 32 | Artificial biological neural network | [DD013](../design_documents/DD013_Hybrid_Mechanistic_ML_Framework.md) (neural network architecture) |
