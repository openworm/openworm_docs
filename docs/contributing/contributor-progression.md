...
**DD020 data digitization as a contribution pathway:** DD020 identifies approximately 18 hours of data digitization work for Phase 1 — extracting published experimental data from figures and tables into machine-readable formats. These tasks are ideal L1 contributions because they are structured, clearly scoped, scientifically meaningful, and teach contributors the biology as they work:
...
**Option 1: BadgeList as primary (recommended for Phase 3)**
