# Contributor Progression Model (The Graduated Access System)
...
- Badge definitions — full badge taxonomy (see [Badge & Recognition System](#badge-recognition-system) below) created in BadgeList via API
...
- Responsibilities:
  ...
  - Ensure PRs comply with relevant Design Documents **including Integration Contract sections** ([DD001](../design_documents/DD001_Neural_Circuit_Architecture.md)-[DD013](../design_documents/DD013_Simulation_Stack_Architecture.md))
...
| **Integration Stack** | [DD013](../design_documents/DD013_Simulation_Stack_Architecture.md) | TBD — **Critical hire** | OpenWorm (meta-repo) |
| **Visualization** | [DD014](../design_documents/DD014_Dynamic_Visualization_Architecture.md) | TBD | Worm3DViewer, Worm Browser |
...
5. **Activity metrics:** Reference [DD028](../design_documents/DD028_Project_Metrics_Dashboard.md) as the data source for contributor activity metrics (PRs merged, badges earned, active days in last 30 days) displayed per contributor or per level
...
| **Explorer** | Navigate the OpenWorm viewer ([DD014](../design_documents/DD014_Dynamic_Visualization_Architecture.md) Stage 1 Trame viewer or legacy Worm Browser), identify 5 neurons, describe their function and one connection | N2-Whisperer evaluates response | — |
...
| **Movement Analyst** | Run analysis toolbox on sample data, generate report | [DD021](../design_documents/DD021_Movement_Analysis_Toolbox_and_WCON_Policy.md) | "Movement Database User" (3 earners) |
...
| **Visualization Contributor** | 5+ merged PRs in Worm3DViewer/browser | [DD014](../design_documents/DD014_Dynamic_Visualization_Architecture.md) |
| **Integration Contributor** | 5+ merged PRs in simulation stack glue | [DD013](../design_documents/DD013_Simulation_Stack_Architecture.md) |
...
- Data sourced from [DD028](../design_documents/DD028_Project_Metrics_Dashboard.md) dashboard metrics
...
- **"State of the Worm" newsletter** content is generated from [DD028](../design_documents/DD028_Project_Metrics_Dashboard.md) metrics data, formatted by Mind-of-a-Worm, and distributed via email
...
- **DD024 (Validation Data Acquisition Pipeline):** Provides structured data digitization tasks suitable for L1 contributor onboarding; digitized datasets feed into [DD010](../design_documents/DD010_Validation_Framework.md) validation gates
...
- "State of the Worm" monthly newsletter uses [DD028](../design_documents/DD028_Project_Metrics_Dashboard.md) metrics data
