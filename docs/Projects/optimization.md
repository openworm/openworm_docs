...
!!! info "Related Design Document"
    Model optimization is being formalized in DD013: Hybrid Mechanistic-ML Framework, which specifies differentiable simulation and automated parameter fitting for 1000x speedup over brute-force approaches.
...
- **DD013: Hybrid Mechanistic-ML Framework** — The next-generation optimization approach
