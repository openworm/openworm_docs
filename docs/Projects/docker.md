...
!!! info "Governed by DD011"
    The Docker simulation stack architecture is specified by DD011: Simulation Stack Architecture, which defines the containerized environment, CI/CD pipeline, and `openworm.yml` configuration format.

---

## Continue Reading

- **DD011: Simulation Stack Architecture** — Full specification of the Docker-based stack
