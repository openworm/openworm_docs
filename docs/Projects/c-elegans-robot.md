...
- **DD002: Neural Circuit Architecture** — The 302-neuron model that drives the robot's simplified connectome
- **DD015: Closed-Loop Touch Response** — Bidirectional sensorimotor coupling (the simulation equivalent of the robot's sensor-motor loop)
