...
!!! info "Related Design Documents"
    The muscle-neuron-channel integration pipeline maps to the core simulation chain: [DD002: Neural Circuit Architecture](../design_documents/DD002_Neural_Circuit_Architecture.md) (neurons), [DD003: Muscle Model Architecture](../design_documents/DD003_Muscle_Model_Architecture.md) (muscles), and [DD005: Cell-Type Specialization](../design_documents/DD005_Cell_Type_Differentiation_Strategy.md) (128 distinct neuron classes from CeNGEN data).
...
- **[DD002: Neural Circuit Architecture](../design_documents/DD002_Neural_Circuit_Architecture.md)** — 302-neuron HH model specification
- **[DD003: Muscle Model Architecture](../design_documents/DD003_Muscle_Model_Architecture.md)** — Ca²⁺→force coupling specification
