...
!!! info "Related Design Documents"
    The muscle-neuron-channel integration pipeline maps to the core simulation chain: DD002: Neural Circuit Architecture (neurons), DD003: Muscle Model Architecture (muscles), and DD005: Cell-Type Specialization (128 distinct neuron classes from CeNGEN data).
...
The [muscle model subproject](https://github.com/openworm/muscle_model/) is concerned with modelling and simulation at the *cellular* level, specifically attempting to simulate the electrical dynamics of a _C. elegans_ body wall muscle cell, as specified in DD003 (Muscle Model Architecture).
...
- **DD002: Neural Circuit Architecture** — 302-neuron HH model specification
- **DD003: Muscle Model Architecture** — Ca²⁺→force coupling specification
- **DD005: Cell-Type Specialization** — 128 distinct neuron classes
