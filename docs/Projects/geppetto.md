...
DD012 evaluated Geppetto against alternatives and chose Trame because:
...
## Current Visualization Roadmap (DD012)
...
- **DD012: Dynamic Visualization Architecture** — The next-generation visualization specification
