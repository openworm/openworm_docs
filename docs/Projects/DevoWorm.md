...
- **[Phase 8: Developmental Modeling](../design_documents/DD_PHASE_ROADMAP.md#phase-8-developmental-modeling)** — DevoWorm is the primary existing project for Phase 8 ("Worm That Grows"), which targets multi-stage simulation from L1 larva to adult
- **DD005: Cell-Type Specialization** — DevoWorm's differentiation trees add temporal dynamics to DD005's CeNGEN-based cell-type specification
- **DD004: Mechanical Cell Identity** — DevoWorm's CompuCell3D morphogenesis models inform body-scaling mechanics across developmental stages
