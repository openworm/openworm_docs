...
Please [visit here](https://docs.openworm.org/fullhistory/) for a more extensive history of the project.

More information is available on the past history of [OpenWorm releases](https://docs.openworm.org/releases/).
