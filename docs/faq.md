...
The core OpenWorm team has met in person several times, including early meetings in [Paris (July 2014)](https://openworm.tumblr.com/post/57193347335/community-updates-from-openworm-in-paris) and London (Fall 2014). We use Slack and video calls to meet face to face on a regular basis.
...
[Smoothed Particle Hydrodynamics](https://en.wikipedia.org/wiki/Smoothed-particle_hydrodynamics#Uses_in_solid_mechanics) — a mesh-free method for simulating fluid and solid mechanics using particles. More information is [available online.](https://www.zora.uzh.ch/29724/1/Barbara.pdf)
...
<https://browser.openworm.org>

### How do I join the community?

We primarily use [Slack](https://openworm.org/contacts.html) for day-to-day communication. Fill out our [volunteer application form](https://goo.gl/3ncZWn) to get an invite.

### Where are downloads located?

<https://www.openworm.org/downloads.html>
