...
> **Phase:** [Phase 1](DD_PHASE_ROADMAP.md#phase-1-cell-type-differentiation-months-1-3) | **Layer:** Visualization
...
|----------|-------|-------|
| Geometry source | Marching cubes isosurface from SPH particles (Phase 1); VirtualWorm mesh skinning (Phase 2+) | See [DD012](DD012_Dynamic_Visualization_Architecture.md) Surface Reconstruction |
