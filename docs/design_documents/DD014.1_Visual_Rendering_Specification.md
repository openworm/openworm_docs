...
This document defines what the OpenWorm simulation **looks like** — exact colors, materials, lighting, transparency, transitions, and rendering algorithms for every visual element at every scale. [DD014](DD014_Dynamic_Visualization_Architecture.md) specifies the architecture (data pipeline, Zarr schema, Trame/Three.js framework, Docker integration); [DD014.1](DD014.1_Visual_Rendering_Specification.md) specifies the visual design. A developer should be able to implement any visual element by reading [DD014.1](DD014.1_Visual_Rendering_Specification.md) (appearance) and [DD014](DD014_Dynamic_Visualization_Architecture.md) (data format) without guessing.
...
- Related: [DD014](DD014_Dynamic_Visualization_Architecture.md) parent DD (viewer architecture)

## How to Build & Test

- **Prerequisites:** DD014 viewer running locally (see [DD014](DD014_Dynamic_Visualization_Architecture.md))
...
[DD014.1](DD014.1_Visual_Rendering_Specification.md) specifies purely: what things look like, what color they are, how they glow, how they transition between scales, and what the rendering algorithms are.
...
|-----------|----------------|------|--------|
| Input | [DD014](DD014_Dynamic_Visualization_Architecture.md) | Simulation state data | OME-Zarr |
...
- **Upstream:** [DD014](DD014_Dynamic_Visualization_Architecture.md) (viewer architecture), [DD005](DD005_Cell_Type_Differentiation_Strategy.md) (cell type list determines color assignments)
