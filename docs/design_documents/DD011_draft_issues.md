...
- **Title:** `[DD011] Create openworm.yml declarative configuration schema`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, yaml
- **DD Section to Read:** [DD011 §1 — Simulation Configuration System](DD011_Simulation_Stack_Architecture.md#1-simulation-configuration-system-openwormyml)
- **Depends On:** None
- **Files to Modify:**
...
- **Acceptance Criteria:**
    - [ ] `openworm.yml` exists at repo root with all sections from DD011 §1 (neural, body, muscle, pharynx, intestine, simulation, validation, output, visualization, viewer)
    - [ ] All default values match DD011 spec (e.g., `neural.level: C1`, `simulation.duration: 15.0`)
...
- **Title:** `[DD011] Write Python validation script for openworm.yml`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, yaml
- **DD Section to Read:** [DD011 §1 — Simulation Configuration System](DD011_Simulation_Stack_Architecture.md#1-simulation-configuration-system-openwormyml)
...
- **Title:** `[DD011] Create multi-stage Dockerfile with base, neural, body, validation, full, and viewer stages`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 §2 — Multi-Stage Docker Build](DD011_Simulation_Stack_Architecture.md#2-multi-stage-docker-build-layered-images)
- **Depends On:** Issue 1
- **Files to Modify:**
...
- **Title:** `[DD011] Create docker-compose.yml with quick-test, simulation, validate, and shell services`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 §3 — Docker Compose for Composable Execution](DD011_Simulation_Stack_Architecture.md#3-docker-compose-for-composable-execution)
- **Depends On:** Issue 3
- **Files to Modify:**
...
- **Title:** `[DD011] Add viewer service to docker-compose.yml for DD012 visualization`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 §3 — Docker Compose](DD011_Simulation_Stack_Architecture.md#3-docker-compose-for-composable-execution) (viewer service block) and [DD012](DD012_Dynamic_Visualization_Architecture.md)
- **Depends On:** Issue 4
- **Files to Modify:**
...
- **Sponsor Summary Hint:** The viewer service launches a 3D visualization of the simulation output (body shape, neural activity, muscle forces) in a web browser. It reads the OME-Zarr data bus — the universal data format that all subsystems write to. See [DD012](DD012_Dynamic_Visualization_Architecture.md).

---

### Issue 6: Add neural-dev service to docker-compose

- **Title:** `[DD011] Add neural-dev service to docker-compose.yml for neural-only development`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 §3 — Docker Compose](DD011_Simulation_Stack_Architecture.md#3-docker-compose-for-composable-execution) (neural-dev service block)
- **Depends On:** Issue 4
- **Files to Modify:**
...
- **Title:** `[DD011] Create versions.lock file with pinned dependency commits`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** git, yaml
- **DD Section to Read:** [DD011 §4 — Dependency Pinning](DD011_Simulation_Stack_Architecture.md#4-dependency-pinning-versionslock)
- **Depends On:** None
- **Files to Modify:**
...
- **Title:** `[DD011] Write build.sh script that reads versions.lock and passes build args to Docker`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, docker
- **DD Section to Read:** [DD011 §4 — Dependency Pinning](DD011_Simulation_Stack_Architecture.md#4-dependency-pinning-versionslock) (build script section)
- **Depends On:** Issue 7
- **Files to Modify:**
...
- **Title:** `[DD011] Refactor master_openworm.py to load and use openworm.yml configuration`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 1) and [DD011 §1 — Config System](DD011_Simulation_Stack_Architecture.md#1-simulation-configuration-system-openwormyml)
- **Depends On:** Issue 1
- **Files to Modify:**
    - `master_openworm.py`
- **Test Commands:**
...
- **Title:** `[DD011] Implement master_openworm.py Step 2: conditional subsystem initialization`
...
- **Title:** `[DD011] Implement master_openworm.py Step 3: configurable coupled simulation loop`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, neuroml
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 3)
- **Depends On:** Issue 10
- **Files to Modify:**
    - `master_openworm.py`
- **Test Commands:**
...
- **Title:** `[DD011] Create scripts/quick-test.sh smoke test for contributors`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker, testing
- **DD Section to Read:** [DD011 §3 — Docker Compose](DD011_Simulation_Stack_Architecture.md#3-docker-compose-for-composable-execution) and [DD011 Quality Criteria](DD011_Simulation_Stack_Architecture.md#quality-criteria) (criterion 2: <5 min)
- **Depends On:** Issue 4
- **Files to Modify:**
...
- **Title:** `[DD011] Create GitHub Actions CI Gate 1: Docker build verification`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** ci-cd
- **DD Section to Read:** [DD011 §6 — CI/CD Pipeline](DD011_Simulation_Stack_Architecture.md#6-cicd-pipeline-automated-quality-gates) (Gate 1)
- **Depends On:** Issue 3
- **Files to Modify:**
...
- **Title:** `[DD011] Create GitHub Actions CI Gate 2: smoke test after build`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** ci-cd
- **DD Section to Read:** [DD011 §6 — CI/CD Pipeline](DD011_Simulation_Stack_Architecture.md#6-cicd-pipeline-automated-quality-gates) (Gate 2)
...
- **Title:** `[DD011] Fix video pipeline memory leak (OOM at >2s simulations)`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, docker
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (video pipeline fix options) and [DD011 Context — Known Issues](DD011_Simulation_Stack_Architecture.md#known-critical-issues)
- **Depends On:** None
- **Files to Modify:**
...
- **Title:** `[DD011] Fix Docker GPU passthrough and backend selection`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
...
- **Title:** `[DD011] Pin apt package versions and add Python virtualenv to Dockerfile`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 Context — Known Issues](DD011_Simulation_Stack_Architecture.md#known-critical-issues) (dependency pinning, virtualenv rows) and [DD011 §4 — Dependency Pinning](DD011_Simulation_Stack_Architecture.md#4-dependency-pinning-versionslock)
- **Depends On:** Issue 3
- **Files to Modify:**
...
- **Title:** `[DD011] Implement master_openworm.py Step 4: output generation (plots, WCON, video)`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 4)
- **Depends On:** Issue 11
- **Files to Modify:**
...
- **Title:** `[DD011] Implement master_openworm.py Step 4b: OME-Zarr data export for DD012 viewer`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 4b) and [DD012](DD012_Dynamic_Visualization_Architecture.md) (OME-Zarr schema)
- **Depends On:** Issue 18
- **Files to Modify:**
...
- **Acceptance Criteria:**
    ...
    - [ ] Zarr file readable by [DD012](DD012_Dynamic_Visualization_Architecture.md) viewer
- **Sponsor Summary Hint:** OME-Zarr is the universal data bus for the whole simulation — every subsystem writes its state to a shared Zarr store. The [DD012](DD012_Dynamic_Visualization_Architecture.md) viewer reads this to render 3D visualizations. It's like a shared whiteboard where each organ writes its current state, and the viewer reads all of them at once.

---

### Issue 20: `master_openworm.py` Step 5 — DD010 validation

- **Title:** `[DD011] Implement master_openworm.py Step 5: DD010 validation framework integration`
- **Labels:** `DD011`, `human-expert`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, testing
- **DD Section to Read:** [DD011 §5 — Enhanced master_openworm.py](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 5) and [DD010](DD010_Validation_Framework.md)
- **Depends On:** Issue 18
- **Files to Modify:**
...
- **Title:** `[DD011] Create GitHub Actions CI Gate 3: Tier 2 validation on pull requests`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** ci-cd
- **DD Section to Read:** [DD011 §6 — CI/CD Pipeline](DD011_Simulation_Stack_Architecture.md#6-cicd-pipeline-automated-quality-gates) (Gate 3)
...
- **Title:** `[DD011] Create GitHub Actions CI Gate 4: Tier 3 behavioral validation on main branch`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** ci-cd
- **DD Section to Read:** [DD011 §6 — CI/CD Pipeline](DD011_Simulation_Stack_Architecture.md#6-cicd-pipeline-automated-quality-gates) (Gate 4)
- **Depends On:** Issue 21
- **Files to Modify:**
...
- **Title:** `[DD011] Add JupyterLab service to docker-compose.yml for interactive exploration`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 §9 — JupyterLab Interface](DD011_Simulation_Stack_Architecture.md#9-jupyterlab-interface-issue-347)
- **Depends On:** Issue 4
- **Files to Modify:**
...
- **Title:** `[DD011] Create starter notebook 02_run_c302_network.ipynb`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, neuroml
...
- **Title:** `[DD011] Create starter notebook 03_analyze_output.ipynb`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python
- **DD Section to Read:** [DD011 §9 — JupyterLab Interface](DD011_Simulation_Stack_Architecture.md#9-jupyterlab-interface-issue-347)
...
- **Title:** `[DD011] Create starter notebook 04_validate_against_data.ipynb`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, testing
- **DD Section to Read:** [DD011 §9 — JupyterLab Interface](DD011_Simulation_Stack_Architecture.md#9-jupyterlab-interface-issue-347) and [DD010](DD010_Validation_Framework.md)
- **Depends On:** Issue 23
- **Files to Modify:**
...
- **Title:** `[DD011] Add DD005 cell-type specialization config hooks and subsystem init`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python
- **DD Section to Read:** [DD005](DD005_Cell_Type_Differentiation_Strategy.md) (Integration Contract) and [DD011 §1](DD011_Simulation_Stack_Architecture.md#1-simulation-configuration-system-openwormyml) (`neural.differentiated` config)
- **Depends On:** Issue 9
- **Files to Modify:**
...
- **Title:** `[DD011] Add DD004 mechanical cell identity integration for Sibernetic particles`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/Sibernetic`
- **Required Capabilities:** python
- **DD Section to Read:** [DD004](DD004_Mechanical_Cell_Identity.md) (Integration Contract) and [DD011 §5](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 4b, `body/cell_ids` in OME-Zarr)
- **Depends On:** Issue 19
- **Files to Modify:**
...
- **Title:** `[DD011] Add DD006 neuropeptide modulation coupling to simulation loop`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** `openworm/c302` + `openworm/OpenWorm`
- **Required Capabilities:** python, neuroml
- **DD Section to Read:** [DD006](DD006_Neuropeptidergic_Connectome_Integration.md) (Integration Contract) and [DD011 §5](DD011_Simulation_Stack_Architecture.md#5-enhanced-master_openwormpy-implement-all-5-steps) (Step 3, coupling)
- **Depends On:** Issue 11
- **Files to Modify:**
...
- **Title:** `[DD011] Add DD007 pharyngeal nervous system integration to simulation stack`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** New pharynx repo + `openworm/OpenWorm`
- **Required Capabilities:** python, neuroml
- **DD Section to Read:** [DD007](DD007_Pharyngeal_Nervous_System_Architecture.md) (Integration Contract) and [DD011 §7](DD011_Simulation_Stack_Architecture.md#7-contributor-development-workflow) (adding new subsystem workflow)
- **Depends On:** Issue 11
- **Files to Modify:**
...
- **Title:** `[DD011] Add DD009 intestinal oscillator model integration to simulation stack`
- **Labels:** `DD011`, `human-expert`, `L3`
- **Target Repo:** New intestine repo + `openworm/OpenWorm`
- **Required Capabilities:** python, neuroml
- **DD Section to Read:** [DD009](DD009_Intestinal_Oscillator_Model.md) (Integration Contract) and [DD011 §7](DD011_Simulation_Stack_Architecture.md#7-contributor-development-workflow) (adding new subsystem workflow)
- **Depends On:** Issue 11
- **Files to Modify:**
...
- **Title:** `[DD011] Write getting-started guide for new contributors`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docs
- **DD Section to Read:** [DD011 §7 — Contributor Development Workflow](DD011_Simulation_Stack_Architecture.md#7-contributor-development-workflow) and [DD011 Quality Criteria](DD011_Simulation_Stack_Architecture.md#quality-criteria) (criterion 8: clone-to-simulation in <30 min)
...
- **Acceptance Criteria:**
    ...
    - [ ] Links to DD011 for architecture understanding
...
- **Title:** `[DD011] Configure MyBinder.org for zero-install browser-based simulation demo`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docker
- **DD Section to Read:** [DD011 Phase D](DD011_Simulation_Stack_Architecture.md#phase-d-polish-and-onboarding-weeks-17-20) and [DD011 Open Questions](DD011_Simulation_Stack_Architecture.md#open-questions-require-founder-input) (question 3)
- **Depends On:** Issue 23
- **Files to Modify:**
...
- **Title:** `[DD011] Create GitHub Actions workflow for automated Docker Hub image publishing`
- **Labels:** `DD011`, `ai-workable`, `L2`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** ci-cd, docker
- **DD Section to Read:** [DD011 §8 — Pre-Built Images](DD011_Simulation_Stack_Architecture.md#8-pre-built-images-on-docker-hub) and [DD011 Phase D](DD011_Simulation_Stack_Architecture.md#phase-d-polish-and-onboarding-weeks-17-20)
- **Depends On:** None
- **Files to Modify:**
...
- **Title:** `[DD011] Update N2-Whisperer orientation tasks for new simulation stack`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** docs
- **DD Section to Read:** [DD011 Phase D](DD011_Simulation_Stack_Architecture.md#phase-d-polish-and-onboarding-weeks-17-20) and [Contributor Progression](../contributing/contributor-progression.md) (L0→L1 orientation tasks)
- **Depends On:** Issue 32
- **Files to Modify:**
...
- **Title:** `[DD011] Survey sibernetic_config_gen repo for reusable particle config generation code`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, git
- **DD Section to Read:** [DD011 Existing Code Resources](DD011_Simulation_Stack_Architecture.md#existing-code-resources) (sibernetic_config_gen section)
- **Depends On:** None
- **Files to Modify:**
...
- **Title:** `[DD011] Survey skeletonExtraction repo for reusable skeleton export code`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, git
- **DD Section to Read:** [DD011 Existing Code Resources](DD011_Simulation_Stack_Architecture.md#existing-code-resources) (skeletonExtraction section) and [DD017](DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md) (WCON export)
- **Depends On:** None
- **Files to Modify:**
    - None (research issue — output is a summary comment on the issue)
- **Test Commands:**
...
- **Acceptance Criteria:**
    ...
    - [ ] Estimate time savings if reused vs. rewriting
    - [ ] Post findings as issue comment
- **Sponsor Summary Hint:** This 2016 repo extracts the worm's centerline (a 49-point skeleton) from the cloud of ~100,000 Sibernetic particles — like finding the backbone inside a blob. This skeleton is essential for converting simulation output to WCON format (the standard for worm movement data) which [DD017](DD017_Movement_Analysis_Toolbox_and_WCON_Policy.md) needs for validation. Saves 15-25 hours if reusable.

---

### Issue 38: Survey `sibernetic_NEURON` for reuse

- **Title:** `[DD011] Survey sibernetic_NEURON repo for Sibernetic-NEURON interface patterns`
- **Labels:** `DD011`, `ai-workable`, `L1`
- **Target Repo:** `openworm/OpenWorm`
- **Required Capabilities:** python, git
- **DD Section to Read:** [DD011 Existing Code Resources](DD011_Simulation_Stack_Architecture.md#existing-code-resources) (sibernetic_NEURON section) and [DD015](DD015_Closed_Loop_Touch_Response.md) (bidirectional coupling)
- **Depends On:** None
- **Files to Modify:**
    - None (research issue — output is a summary comment on the issue)
- **Test Commands:**
...
- **Acceptance Criteria:**
    ...
    - [ ] Document: Are there bidirectional coupling patterns applicable to DD015 (closed-loop touch response)?
    - [ ] Document: Is any code directly reusable?
    - [ ] Post findings as issue comment
- **Sponsor Summary Hint:** Before `sibernetic_c302.py` (the current coupling code), there was `sibernetic_NEURON` — an earlier attempt at connecting the body physics engine to the neural simulator. Reviewing it may reveal useful patterns for implementing bidirectional sensory feedback (touch → neural response → movement change) as specified in [DD015](DD015_Closed_Loop_Touch_Response.md).
