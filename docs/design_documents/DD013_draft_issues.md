...
| DD016 (Connectome Data Access) | Neurotransmitter data consolidation |

### Dependency Graph

```
Issue 1 (consolidate neurotransmitter constraints) — independent
Issue 2 (synapse_optimization config) — depends on DD011 Issue 1
