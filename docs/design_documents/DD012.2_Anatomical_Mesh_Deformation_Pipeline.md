...
**Before:** [DD012](DD012_Dynamic_Visualization_Architecture.md) Viewer Stage 1 (Roadmap Phase 1) uses marching cubes to reconstruct a smooth body surface from SPH particles. The 688 Virtual Worm meshes sit as static, undeformed geometry inside a moving body — completely wrong.
...
| **Example PR title** | `DD012.2: Implement spine-based deformation for Phase 1 viewer` |
...
3. **Growth and developmental changes.** Body size and shape change during larval development (L1-L4 → adult). [DD012.2](DD012.2_Anatomical_Mesh_Deformation_Pipeline.md) assumes a fixed adult body. Developmental morphing is Phase 6 work.
...
| Muscle activation (optional, Phase 3) | [DD003](DD003_Muscle_Model_Architecture.md) | Per-muscle [0,1] | OME-Zarr: `muscle/activation/` | dimensionless |
...
| Muscle activation (Phase 3) | [DD003](DD003_Muscle_Model_Architecture.md) | If activation range or muscle ID mapping changes, per-muscle deformation offsets must be updated |
